...
export default function HeroScene({ effectOptions = DEFAULT_EFFECT_OPTIONS }) {
    ...
    class App {
      ...
      initPasses() {
        ...
        if (!context || (context.isContextLost && context.isContextLost())) {
          console.warn("WebGL context lost or null during initPasses");
          this.webglSupported = false;
          return;
        }
        ...
        try {
          ...
          console.error("Failed to initialize postprocessing passes:", e);
          this.webglSupported = false;
        }
      }
      ...
      init() {
        ...
        const context = this.renderer.getContext();
        if (!context || (context.isContextLost && context.isContextLost())) {
          console.warn("WebGL context lost or null during init");
          this.webglSupported = false;
          return;
        }
